const Footer = () => {
  ...
  return (
    <footer className="bg-dark-lighter border-t border-gray-800 py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md">
              Transformando vidas a través del fitness funcional de alta intensidad.
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#que-es-crossfit" className="text-gray-400 hover:text-primary transition-colors">
                  Qué es CrossFit
                </a>
              </li>
              <li>
                <a href="#planes" className="text-gray-400 hover:text-primary transition-colors">
                  Planes
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://instagram.com/crossfitcidra"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-dark hover:bg-primary rounded-full flex items-center justify-center transition-colors"
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>
            &copy; {currentYear} CrossFit Cidra. Todos los derechos reservados.
          </p>
